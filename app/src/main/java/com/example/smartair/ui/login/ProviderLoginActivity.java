...
/**
 * Purpose: Provider login screen.
 * Layer: View (UI)
 * Used For: Email/password login via LoginPresenterImpl.
 */
public class ProviderLoginActivity extends AppCompatActivity implements LoginContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.account_activity_provider_li);
